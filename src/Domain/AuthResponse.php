...
class AuthResponse
{
    ...
    /**
     * @var null|string Unique identifier for the device that response to the auth request.
     */
    private $deviceId;
    ...
    /**
     * Get the unique identifier for the device that response to the auth request.
     *
     * @return null|string
     */
